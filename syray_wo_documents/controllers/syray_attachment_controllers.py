...
# Report Controllers #
######################
class SyrayAttachmentController(AttachmentController):

    @http.route(['/report/download'], type='http', auth="user")
    def report_download(self, data, token):
        res = super(SyrayAttachmentController, self).report_download(data, token)
...
# Binary Controllers #
######################
class SPdfBinaryController(Binary):
    ...
    def content_common(self, xmlid=None, model='ir.attachment', id=None, field='datas',
        ...
        res = super(SyrayAttachmentController, self).content_common(xmlid=xmlid, model=model, id=id, field=field,
